...
- `validation\kubios_subset\frequency_domain_sequence_debug\frequency_domain_sequence_audit.csv`
- `validation\kubios_subset\frequency_domain_sequence_debug\full_vs_selected_sequence_metric_summary.csv`
- `validation\kubios_subset\frequency_domain_sequence_debug\full_vs_selected_sequence_per_recording.csv`
...
- `validation\research_notes\kubios_frequency_domain_sequence_alignment_audit.md`
- `validation\research_notes\frequency_domain_kubios_matched_sequence_validation_report.md`
